    ...
    try {
      ...
      switch (entityType) {
        case 'client':
          ...
          setDataState(prev => ({ ...prev, clients: convertedData as Client[] }));
          break;
        case 'worker':
          convertedData = DataProcessor.convertToWorkers(data);
          setDataState(prev => ({ ...prev, workers: convertedData as Worker[] }));
          break;
        case 'task':
          convertedData = DataProcessor.convertToTasks(data);
          setDataState(prev => ({ ...prev, tasks: convertedData as Task[] }));
          break;
      }
